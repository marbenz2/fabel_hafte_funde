  ...
  return (
    <>
      <Container className="text-primary/60 grid-cols-5">
        <div className="order-2 lg:order-1 col-span-5 lg:col-span-3 flex flex-col w-full h-full justify-center gap-8 py-12 px-4 lg:px-32">
        ...
        <img
          className="order-1 lg:order-2 col-span-5 lg:col-span-2 h-full w-full object-cover"
